...
{% tab title="Previous-bin-tree.js" %} {% embed url="https://replit.com/@bgoonz/TrickyPreviousBinarytree\#index.html" %}

{% embed url="https://trickypreviousbinarytree.bgoonz.repl.co/" %} {% endtab %} {% endtabs %}
